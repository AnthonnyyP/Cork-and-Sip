...
urlpatterns = [
    ...
    # Tastings
    path('guests/<int:guest_id>/add_tasting',
         views.add_tasting, name='add_tasting'),
    # Wines
    ...
    # Cellar
    path('guests/<int:guest_id>/add_to_cellar/<int:wine_id>/',
         views.add_to_cellar, name="add_to_cellar"),
    path('guests/<int:guest_id>/remove_from_cellar/<int:wine_id>/',
         views.remove_from_cellar, name="remove_from_cellar"),
    # Account Sign-Up
